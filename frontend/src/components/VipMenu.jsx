...
export default function VipMenu() {
  ...
  const { data: categorias = [], isLoading } = useQuery({
    ...
    queryFn: () =>
      fetch(`${apiUrl}/vip/categorias/menu_completo/`).then(res => {
  ...
  const handleToggle = () => {
    if (!menuAbierto && categorias.length > 0 && !categoriaActiva) {
  ...
  const productosActivos = (categoriaActiva?.productos || []).filter(p => p.activo !== false)
    ...
    >
      ...
      <div className="container mx-auto px-4 py-14">
        ...
        >
          ...
          <h2 className="font-script text-5xl md:text-6xl font-bold mb-3" style={{ color: '#D4AF37' }}>
            Experiencia Premium
          </h2>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
            ...
            >
              <p className="font-inter text-xs uppercase tracking-widest mb-3" style={{ color: 'rgba(212,175,55,0.6)' }}>
                Categorías
              </p>
            ...
            >
              {/* Contenedor con fondo crema redondeado */}
              <div
                className="relative rounded-3xl overflow-hidden px-8 pt-10 pb-0"
              ...
              >
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <VipCarousel productos={productosActivos} />
                  </motion.div>
                </AnimatePresence>

                {/* Franja terracota inferior decorativa */}
                <div
                  className="mt-8 -mx-8 h-14"
                  style={{
